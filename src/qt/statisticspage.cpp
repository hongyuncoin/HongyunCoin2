...
void StatisticsPage::updateStatistics()
{
    ...
    else if (pindexBest->nHeight > 10 && pindexBest->nHeight < 1000000)
    {
...
/*    else if (pindexBest->nHeight > 50000 && pindexBest->nHeight < 60000)
    ...
    {
        ui->volumeBox->setText("<font color=\"green\">" + qVolume + " HongyunCoin2" + "</font>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<font color=\"red\">" + qVolume + " HongyunCoin2" + "</font>");
    } else {
        ui->volumeBox->setText(qVolume + " HongyunCoin2");
    }
