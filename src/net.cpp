...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("HongyunCoin2-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("HongyunCoin2-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HongyunCoin2 " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("HongyunCoin2-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("HongyunCoin2-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("HongyunCoin2-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("HongyunCoin2-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HongyunCoin2 is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("HongyunCoin2-start");
